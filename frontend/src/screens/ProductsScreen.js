            ...
            <form onSubmit={submitHandler}>
                <ul className="form-container">
                    ...
                    <li>
                        ...
                        <input type="category" id="category" value={category} name="category" onChange={(e)=>setCategory(e.target.value)}></input>
                    </li>
                    <li>
                        <label htmlFor="countInStock">Count In Stock</label>
                        <input type="countInStock" id="countInStock" value={countInStock} name="price" onChange={(e)=>setCountInStock(e.target.value)}></input>
                    </li>
                    <li>
